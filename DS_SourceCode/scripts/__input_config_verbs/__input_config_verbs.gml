...
function __input_config_verbs()
{
    return {
        keyboard_and_mouse:
        {
            ...
            kick:  input_binding_key("Y"),
            punch:  input_binding_key("U"),
            jump:  input_binding_key("H"),
            special: input_binding_key("J"),
            flow: input_binding_key("I"),
            guard: input_binding_key("K"),
        ...
        gamepad:
        {
            ...
            kick:  input_binding_gamepad_button(gp_face3),
            punch:  input_binding_gamepad_button(gp_face4),
            jump:  input_binding_gamepad_button(gp_face1),
            special: input_binding_gamepad_button(gp_face2),
            flow:     input_binding_gamepad_button(gp_shoulderl),
            guard:     input_binding_gamepad_button(gp_shoulderr),
